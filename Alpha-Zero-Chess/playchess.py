...
if __name__=='__main__':
    ...
    parser.add_argument( '--model', help='Path to model (.pt) file.', default='AlphaZeroNet_20x256.pt')
    ...
    parser.set_defaults( verbose=True, mode='s', color='w', rollouts=1000, threads=7, fen= "r2q1rk1/3nbppp/3pb3/4p1PN/pp2P3/4BP2/PPPQ3P/N1KR1B1R b - - 1 16")
